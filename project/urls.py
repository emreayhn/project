...
from core.views import CreateUserView, UsersListCreate, UsersList
...
urlpatterns = [
    ...
    path("users/", UsersListCreate.as_view(), name="user-list-create"),
    path("scoreboard/", UsersList.as_view(), name="user-list"),
